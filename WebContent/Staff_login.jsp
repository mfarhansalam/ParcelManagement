...
<body class="text-center">
	<div class="form-signin">
		<button class="w-50 tab-btn p-3 disable" onclick="window.location.href='Student_login.jsp'">Student</button><button class="w-50 tab-btn p-3 fw-bold" onclick="window.location.href='Staff_login.jsp'">Staff</button>
		<main class="p-4">
